...
class Utils {
    ...
    static checkUrlSecret() {
        try {
            // The value you want to check
            const knownSecretValue = process.env.JF_URL;
            if (!knownSecretValue) {
            ...
            let isSecretValueDefined = false;
    ...
    static getMarkdownFooter() {
        return '\n\n # \n\n The above Job Summary was generated by the <a href="https://github.com/jfrog/setup-jfrog-cli/blob/master/README.md#github-job-summaries"> Setup JFrog CLI GitHub Action </a>';
    }
}
exports.Utils = Utils;
